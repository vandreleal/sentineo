    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <link rel="mask-icon" href="/icons/safari-pinned-tab.svg" color="#555" />

          {/* Twitter */}
          <meta name="twitter:card" content="summary" />
          <meta name="twitter:url" content="https://sentineo.app" />
          <meta name="twitter:title" content="Sentineo" />
          <meta name="twitter:description" content="Near-Earth Objects Viewer" />
          <meta name="twitter:image" content="https://sentineo.app/icons/android-chrome-192x192.png" />
          ...
          <meta property="og:image" content="https://sentineo.app/icons/apple-touch-icon.png" />
